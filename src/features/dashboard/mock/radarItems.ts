...
export const radarItems: RadarItem[] = [
  {
    ...
    companyProfile: {
      ...
      idealCandidate:
        "「21世紀を代表する会社を創る」というビジョンに共感し、自ら手を挙げて新規事業や難題に挑める人。素直でいいやつであること、チームで成果を出せる協調性、そして圧倒的な当事者意識を重視。学生時代に何かを本気でやり切った経験と、明確な意思を持って意思決定してきたストーリーがあると評価されやすい。エンジニアコースでは技術への探究心とプロダクト志向、ビジネスコースでは事業づくりへの執着と論理的思考、デザイナーコースではユーザー体験への洞察力が問われる。",
      cultureDescription:
        "「若手の抜擢」と「挑戦を称賛する文化」が根付くメガベンチャー。年次や肩書きに関係なく新規事業の立ち上げを任される一方、結果に対してはフラットにフィードバックが行われる。社内公募制度「CAJJ」やあした会議など、現場発の意思決定の仕組みが多数。役員と社員の距離が近く、渋谷スクランブルスクエアのオフィスはコミュニケーション重視のオープンな作り。飲み会や社内イベントも多くウェットな側面があり、チームで盛り上がって走るタイプが馴染みやすい。",
      cultureTags: ["若手抜擢", "新規事業志向", "成果主義", "チーム志向", "風通し◯", "渋谷カルチャー"]
    }
  },
  {
    id: "r2",
    ...
    participants: [
      {
        ...
        role: "主催",
        companyProfile: {
          overview: "ABEMA・ゲーム・インターネット広告を展開するメガベンチャー。",
          industry: "インターネット / メディア / 広告",
          founded: "1998年3月",
          headquarters: "東京都渋谷区",
          employees: "連結 約7,400名",
          hiringCount: "新卒100名以上",
          hiringRoles: ["エンジニア", "ビジネス", "デザイナー"],
          website: "https://www.cyberagent.co.jp",
          mission: "新しい力とインターネットで日本の閉塞感を打破する"
        }
      },
      {
        ...
        role: "参加",
        companyProfile: {
          overview: "フリマアプリ「メルカリ」を運営。USにも展開するグローバルスタートアップ。",
          industry: "EC / フィンテック",
          founded: "2013年2月",
          headquarters: "東京都港区",
          employees: "連結 約2,300名",
          hiringCount: "新卒20〜30名",
          hiringRoles: ["エンジニア", "デザイナー"],
          website: "https://about.mercari.com"
        }
      },
      {
        companyName: "株式会社ミクシィ",
        role: "参加",
        companyProfile: {
          overview: "モンスターストライク・スポーツ・ライフスタイル事業を展開。",
          industry: "エンターテインメント / スポーツ",
          founded: "1999年6月",
          headquarters: "東京都渋谷区",
          employees: "連結 約2,000名",
          hiringCount: "新卒30名程度",
          hiringRoles: ["エンジニア", "プランナー"],
          website: "https://mixi.co.jp"
        }
      },
      {
        ...
        role: "参加",
        companyProfile: {
          overview: "クラウド会計・人事労務ソフトでSMB支援。ミッションドリブンなSaaS企業。",
          industry: "SaaS / フィンテック",
          founded: "2012年7月",
          headquarters: "東京都品川区",
          employees: "約1,800名",
          hiringCount: "新卒若干名",
          hiringRoles: ["エンジニア", "カスタマーサクセス"],
  ...
  },
  {
    ...
    participants: [
      {
        companyName: "マネーフォワード株式会社",
        role: "主催",
        companyProfile: {
          overview: "家計・法人向けクラウドサービスを提供するフィンテック企業。",
          industry: "フィンテック / SaaS",
          founded: "2012年5月",
          headquarters: "東京都港区",
          employees: "連結 約2,600名",
          hiringCount: "新卒20〜30名",
          hiringRoles: ["エンジニア", "ビジネス"],
          website: "https://moneyforward.com"
        }
      },
      {
        companyName: "株式会社SBI新生銀行",
        role: "協賛",
        companyProfile: {
          overview: "SBIグループの銀行。デジタルバンキングに注力。",
          industry: "銀行 / 金融",
          founded: "1952年",
          headquarters: "東京都中央区",
          employees: "約2,400名",
          hiringCount: "新卒若干名",
          hiringRoles: ["総合職", "ITエンジニア"],
          website: "https://www.sbishinseibank.co.jp"
        }
      },
      {
        companyName: "Kyash株式会社",
        role: "参加",
        companyProfile: {
          overview: "送金・決済アプリ「Kyash」を運営するスタートアップ。",
          industry: "フィンテック",
          founded: "2015年8月",
          headquarters: "東京都港区",
          employees: "約200名",
          hiringCount: "新卒若干名",
          hiringRoles: ["エンジニア", "プロダクト"],
